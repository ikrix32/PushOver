...
namespace UnityEditor.XCodeEditor 
{
	public class XCMod 
	{
		...
		public string supported_archs {
			get {
				return (string)_datastore["supported_archs"];
			}
		}

		public string code_sign_identity {
			get {
				return (string)_datastore["code_sign_identity"];
			}
		}

		public string code_sign_entitlements {
			get {
				return (string)_datastore["code_sign_entitlements"];
			}
		}

		public string debug_information_format {
			get {
				return (string)_datastore["debug_information_format"];
			}
		}
